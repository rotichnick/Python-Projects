...
def spin(balance):
    ...
    # below is an unpack operator the * unpacks the contents of the list
...
def get_bet():
    while True:
        bet=input("Waht would you like to bet on each line? $: ")
        if bet.isdigit():
            bet=int(bet)
    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if lines>0:
                ...
                print("Bet line must be between 1 and 3")
        else:
